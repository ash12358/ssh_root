...
if options['clientid'] == '':
    if not python_version:
        input_clientid = raw_input('开启ssh请输入1，开启jupyterssh请输入2，开启tensorboard请输入3:')
    else:
        input_clientid = raw_input('开启ssh请输入1，开启jupyterssh请输入2，开启tensorboard请输入3:')
    
    if input_clientid == '1':
        input_clientid = 'aafb9cead61c5526'
        pass
    elif input_clientid == '2':
        input_clientid = '255dff4caefd6958'
        pass
    elif input_clientid == '3':
        input_clientid = 'd7897d59dfb971f6'
        pass
